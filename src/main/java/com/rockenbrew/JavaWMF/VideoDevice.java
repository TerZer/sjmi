...
public class VideoDevice {
	...
	public static final int FORMAT_Y8 = 3;
	...
	public static final int CAMERA_CONTROL_FLAGS_AUTO = 1;
	public static final int CAMERA_CONTROL_FLAGS_MANUAL = 2;
...
//	private boolean streaming; // instead, check directly with the hardware
	...
	public boolean setVideoProp(long videoPropIndex, long value, long flag) {
		return SetVideoProp(videoPropIndex, value, flag);
	}

	public long getVideoProp(long videoPropIndex, int type) {
		return GetVideoProp(videoPropIndex, type);
	}
	public boolean setDeviceProp(long devicePropIndex, long value, long flag) {
		return SetDeviceProp(devicePropIndex, value, flag);
	}
...
//	}
	...
	private native boolean SetVideoProp(long videoPropIndex, long value, long flag);
	private native long GetVideoProp(long videoPropIndex, int type);
	private native boolean SetDeviceProp(long devicePropIndex, long value, long flag);
